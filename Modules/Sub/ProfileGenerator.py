...
class ProfileGenerator(object):
    ...
    def generate_ra_profile(self, hyper_params, situation_params, node_params,
    ...
    def generate_real_target_profile(self):
        '''
        Real Target에 대한 profile 계산
        :return: Real Target profile
        '''
        pass

    # def generate_virtual_target_profile(self,hyper_params,situation_params,node_params,
    #                                     my_node_status,my_node_signal):
    #     '''
    #     Virtual Target에 대한 profile 계산
    #     :return: Virtual Target profile
    #     '''
    #     vel_x, vel_y = 0, 0
    #
    ...
    #     A = 0 # node_params.virtual_profile_min
    #
    #     if abs(virtual_target_position_x - my_position_x) < TARGETPROXIMITY:
    #         # 안전 거리 이내 인 경우 천천히
    #         vel_x = ((virtual_target_position_x - my_position_x) / (TARGETPROXIMITY * 1.0)) * (1-A) + A
    #     elif (virtual_target_position_x > my_position_x):
    ...
    #         vel_x = 0 - TARGETFORCE
    #
    #     if (abs(virtual_target_position_y - my_position_y) < TARGETPROXIMITY):
    #         # 안전 거리 이내 인 경우 천천히
    #         vel_y = ((virtual_target_position_y - my_position_y) / (TARGETPROXIMITY * 1.0)) * (1-A) + A
    #     elif (virtual_target_position_y > my_position_y):
    #         # 안전 거리보다 멀리 떨어진 경우 Force 만큼
    #         vel_y = TARGETFORCE
    #     else:
    #         # 안전 거리보다 멀리 떨어진 경우 Force 만큼
    #         vel_y = 0 - TARGETFORCE
    #
    #     ratio = abs(virtual_target_position_y - my_position_y) / (
    #             abs(virtual_target_position_x - my_position_x) * 1.0)
    #     if (ratio < 1.0):
    #         vel_y = vel_y * ratio
    #
    #     ratio = abs(virtual_target_position_x - my_position_x) / (
    #             abs(virtual_target_position_y - my_position_y) * 1.0)
    #     if (ratio < 1.0):
    #         vel_x = vel_x * ratio
    #
    #     return vel_x, vel_y

    def generate_destination_profile(self,hyper_params,situation_params,node_params,
                                     my_node_status,my_node_signal):
        '''
